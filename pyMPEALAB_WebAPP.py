...
## If you use the result from this code or any part of this work, Please cite the paper:
    ## U. Subedi, A. Kunwar , Y.A. Coutinho, K. Gyanwali . pyMPEALab toolkit for accelerating phase design in multi-principal element alloys. Metals and Materials International (2022). 
    ## https://doi.org/10.1007/s12540-021-01100-9
...
element_symbols = ['Click to Select','Ag', 'Al', 'Au', 'B', 'Be', 'Ca', 'Ce', 'Co', 'Cr', 'Cu', 'Fe', 'Gd', 'Hf', 'La', 'Li', 'Mg', 'Mn', 'Mo', 'Nb', 'Nd', 'Ni', 'Pd', 'Sc', 'Si', 'Sn', 'Sr', 'Ta', 'Ti', 'V', 'W', 'Y', 'Yb', 'Zn', 'Zr']
...
prop_2 = s_col21.markdown(f"Temperature of Melting <span style='margin-right: 70px;'>&nbsp;</span> (&Delta; Tm)", unsafe_allow_html=True)
prop_2 = s_col21.markdown(f"Omega Parameter <span style='margin-right: 108px;'>&nbsp;</span> (&Omega;)", unsafe_allow_html=True)
...
#############
### Prediction 
predict_button = st.button("PREDICT PHASE")
...
<br><br>Subedi, U., Kunwar, A., Coutinho, Y.A., Gyanwali, K.  Metals and Materials International (2022).
<a href="https://doi.org/10.1007/s12540-021-01100-9" style="color: red; text-decoration: underline;" target="_blank">
pyMPEALab toolkit for accelerating phase design in multi-principal element alloys.
</a>
<a href="https://doi.org/10.1007/s12540-021-01100-9" style="color: green; text-decoration: underline;" target="_blank">(https://doi.org/10.1007/s12540-021-01100-9)</a>
</p>
'''
